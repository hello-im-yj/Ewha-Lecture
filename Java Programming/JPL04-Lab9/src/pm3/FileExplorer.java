...
public class FileExplorer {
	...
	private void showSubDirtories() {
		...
		subFiles = currentDir.listFiles(); //File[] 배열로 리턴
		for (File f : subFiles) {
			System.out.print(((f.isFile()) ? "file" : "dir")); //file이면 file 아니면 dir출력
	...
	public static void main(String[] args) {
		FileExplorer fe = new FileExplorer("c:\\"); //생성자로 인해 currentdir 이 c로 지정.
		fe.run();
	}
}
